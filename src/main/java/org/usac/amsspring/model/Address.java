...
public class Address
{
    ...
    protected final String urbanization;             // Urbanization
    ...
    public Address(String addr1, String addr2, String city, String urbanization, String state, String zip5)
    {
        this("", addr1, addr2, city, urbanization, state, zip5, "");
    }

    public Address(String firmName, String addr1, String addr2, String city, String urbanization, String state, String zip5, String zip4)
    {
        this.firmName = (firmName != null) ? firmName : "";
        this.addr1 = (addr1 != null) ? addr1 : "";
        this.addr2 = (addr2 != null) ? addr2 : "";
        this.city = (city != null) ? city : "";
        this.urbanization = (urbanization != null) ? urbanization : "";
    ...
    {
        return !(addr2.trim().isEmpty() && city.trim().isEmpty() && urbanization.trim().isEmpty() &&
